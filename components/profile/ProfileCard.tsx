...
export default function ProfileCard({
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col items-center text-center relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-24 bg-linear-to-r from-primary/10 to-soft-mint/30 z-0" />
      ...
      {isPremium && (
        <div className="flex items-center gap-1 mt-1 mb-6 relative z-10">
          ...
          <span className="text-xs font-semibold text-primary bg-soft-mint px-2 py-0.5 rounded-full">
            Premium Member
          </span>
        </div>
      )}
